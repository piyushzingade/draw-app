        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Create beautiful hand-drawn diagrams, wireframes, and
              illustrations with the power of modern technology.
            </p>
          ...
          >
            <div className="flex justify-center items-center">
              <img
                ...
                className="rounded-lg shadow-2xl max-w-4xl"
              />
            </div>
          </motion.div>
        </div>
        ...
        >
          <div className="bg-card rounded-2xl p-12 shadow-lg">
            ...
            <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
              Join thousands of teams and individuals who use Excalidraw to
